...
const AddProduct = () => {
  ...
  const updateProductHandler = async () => {
    try {
      ...
      if (confirm) {
        await updateProduct({
          variables: { input: { ...productObj, _id: productId } },
        });
    ...
    <Stack className={"add-product"}>
      <Stack className="add-product-head">
        ...
        <Box className="subtitle">
          You can sell your product with this trustful platform!
        </Box>
      </Stack>
      <Stack className="add-poduct-body">
        <CssVarsProvider>
          ...
          <Stack className="add-insert">
            <FormControl sx={{ flex: 1 }}>
              <FormLabel className={"add-label"}>Product Category</FormLabel>
              <Select
            ...
            <FormControl sx={{ flex: 1 }}>
              <FormLabel className={"add-label"}>Product Brand</FormLabel>
              <Select
              ...
              >
                {Object.values(ProductBrand).map(
          ...
          <Stack className="add-insert">
            ...
            <FormControl sx={{ flex: 1 }}>
              ...
              />
              <p
                style={{ color: "red", fontSize: "12pxs", marginLeft: "10px" }}
              >
                THIS IS IN KOREAN CURRENCY
              </p>
            </FormControl>
            <FormControl sx={{ flex: 1 }}>
              <FormLabel className={"add-label"}>Product Label</FormLabel>
              <Select
                placeholder="Select a brand"
                indicator={<KeyboardArrowDown />}
              ...
              >
                {Object.values(ProductLabel).map(
          ...
          {productObj.productCategory === ProductCategory.DESKTOP ||
            ...
            <Stack className="add-pc">
              ...
              <Stack className="add-insert">
                <FormControl sx={{ flex: 1 }}>
                  ...
                  <Input
                    placeholder="Type in here…"
                    value={productObj.productCore}
                    variant="soft"
                    sx={{ padding: "10px" }}
                    onChange={setCoreHandler}
                  />
                </FormControl>
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Serie</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                  ...
                  >
                    {Object.values(ProductSeries).map(
                      (serie: string, index: number) => (
              ...
              <Stack className="add-insert">
                {productObj.productCategory === ProductCategory.LAPTOP ? (
                  <FormControl sx={{ flex: 1 }}>
                    <FormLabel className={"add-label"}>Display Inch</FormLabel>
                    <Select
                      placeholder="Select a brand"
                      indicator={<KeyboardArrowDown />}
                    ...
                    >
                      {[
                        10.1, 11.6, 12.3, 12.5, 13.3, 14, 15.6, 16, 17.3, 18,
                      ].map((inch: number, index: number) => (
                        <Option value={inch} key={inch}>
                          {inch}
                        </Option>
                      ))}
                    </Select>
                ...
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>OS</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                  ...
                  >
                    {Object.values(OperatingSystem).map(
                ...
                <FormControl sx={{ flex: 1 }}>
                  ...
                  <Input
                    placeholder="Type in here…"
                    value={productObj.productGraphics}
                    variant="soft"
                    sx={{ padding: "10px" }}
                    onChange={setGraphicsHandler}
                  />
                </FormControl>
              </Stack>
              <Stack className="add-insert">
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Memory Ram</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                  ...
                  >
                    {[2, 4, 8, 16, 24, 32, 64, 128, 256].map(
                      (memory: number, index: number) => (
                ...
                <FormControl sx={{ flex: 1 }}>
                  ...
                  >
                    {[128, 256, 512, 1024, 2048, 4096, 8192].map(
                      (memory: number, index: number) => (
                        <Option value={memory} key={memory}>
                          {memory}GB
                        </Option>
          ...
          {productObj.productCategory === ProductCategory.MICE ||
          productObj.productCategory === ProductCategory.KEYBOARD ? (
            <Stack className="add-km">
              <Box className="add-title">Keyboard & Mice Inserts</Box>
              <Stack className="add-insert">
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Connectivity</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                  ...
                  >
                    {Object.values(Connectivity).map(
                ...
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Brand</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                    value={productObj.productBrand}
              ...
              <Stack className="add-insert">
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Color</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
          ...
          {productObj.productCategory === ProductCategory.GRAPHICS ? (
            <Stack className="add-graphics">
              ...
              <Stack className="add-insert">
                ...
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>VRAM Storage</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                    value={productObj.productStorage}
                  ...
                  >
                    {[2, 4, 6, 8, 10, 12, 16, 20, 24, 32, 48].map(
                      (memory: number, index: number) => (
                        <Option value={memory} key={memory}>
                          {memory}GB
                        </Option>
          ...
          {productObj.productCategory === ProductCategory.CHAIR ? (
            <Stack className="add-chair">
              ...
              <Stack className="add-insert">
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Fabric Type</FormLabel>
                  <Select
                    placeholder="Select a brand"
                    indicator={<KeyboardArrowDown />}
                ...
                <FormControl sx={{ flex: 1 }}>
                  <FormLabel className={"add-label"}>Chair Weight</FormLabel>
                  <Input
                    type="number"
                    defaultValue={2}
                    sx={{ padding: "10px" }}
        ...
        <Stack className={"product-desc"}>
          ...
          <textarea
            ...
            value={productObj.productDesc}
            className="text-white border tracking-wider"
          ></textarea>
        </Stack>
        <Divider sx={{ borderColor: "white", marginTop: "20px" }} />
        <Stack>
          ...
          <Stack className="upload-images">
            <FileUploader
              handleChange={imagesUploadHandler}
              classes="drag-dropper"
              name="file"
              types={fileTypes}
              multiple={true}
            >
              ...
              <Stack>
                <ul>
                  <li>
                    Valid formatted images: image/jpg image/png image/jpeg
                  </li>
              ...
              <Button
                endIcon={<ArrowSquareOut size={32} />}
                sx={{ marginTop: "10px" }}
              >
                Browse Files
              </Button>
